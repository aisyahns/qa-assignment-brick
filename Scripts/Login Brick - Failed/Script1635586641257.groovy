...
WebUI.setEncryptedText(findTestObject('Login Page - Brick/passField'), 'p4y+y39Ir5MSxNs1t5lTZQ==')

WebUI.click(findTestObject('Login Page - Brick/loginBtn'))

WebUI.verifyEqual(WebUI.getText(findTestObject('Login Page - Brick/errorSuccessMsg')), "Error", FailureHandling.CONTINUE_ON_FAILURE)
